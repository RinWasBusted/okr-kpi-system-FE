      ...
      {!activeMode && (
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:border-orange-300 hover:bg-orange-50/50 transition-colors cursor-pointer"
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-gray-500">Cập nhật mật khẩu hiện tại của bạn</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-medium text-gray-900">Quên mật khẩu</p>
                <p className="text-sm text-gray-500">Đặt lại mật khẩu bằng email xác thực</p>
              </div>
            </div>
            <span className="text-orange-500">→</span>
          </button>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 text-gray-900 bg-white pr-10 ${
                  errors.oldPassword
          ...
          <div className="flex gap-3 pt-4">
            <button
              ...
              className="flex-1 px-4 py-2.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors disabled:opacity-50 cursor-pointer"
            >
              Hủy
            </button>
            <button
              ...
              disabled={changePasswordMutation.isPending}
              className="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer shadow-lg shadow-orange-500/30"
            >
        ...
        <div className="space-y-4">
          {!showVerificationFields ? (
            <>
              ...
              <button
                onClick={handleCancel}
                className="w-full px-4 py-2.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors cursor-pointer"
              >
                Hủy
              </button>
            </>
            ...
            <>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-2.5 text-sm font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600 transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-orange-500/30"
                >
                  <Save size={16} />
                  Đổi mật khẩu
                </button>
